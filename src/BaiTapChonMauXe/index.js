 ...
 *Các  bước  thực hiện
 *1/ dàn layout - done
 *2/ xác định data thay đổi và lưu và trong state - done
 *3/ lấy data trong state đi binđding ra jsx - done
 *4/ bắt sự kiện click cho các nút chọn màu - done
 *5/ cập nhật lại giá trị trong state - done
 * */
